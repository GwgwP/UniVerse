...
3. Ο Υπεύθυνος Γραμματείας εισάγει το ακαδημαικό έτος και το εξάμηνο φοίτησης (1,2,3,4,5,6,7,8) και εισαγάγει τον αριθμό των ECTS που μπορούν να δηλωθούν.
4. Ο Υπεύθυνος Γραμματείας εκκινεί τους απαραίτητους ελέγχους (αν ο αριθμός είναι μεγαλύτερος από 30 και μικρότερος από 130, αν έχουν συμπληρωθεί όλα τα πεδία)
5. Το Σύστημα εμφανίζει την προεπισκόπηση. 
6. Το σύστημα καταχωρεί τις προυποθέσεις
7. Το σύστημα εμφανίζει κατάλληλο μήνυμα. 
