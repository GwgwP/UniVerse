...
4. Το σύστημα κάνει τους απαραίτητους ελέγχους (αν ο αριθμός είναι μεγαλύτερος από 30 και μικρότερος από 130, αν έχουν συμπληρωθεί όλα τα πεδία)
...
4. Το σύστημα επιστρέφει στο Βήμα 3.
...
![Use case 3: circumscription](uml/requirements/useCase3.jpg)