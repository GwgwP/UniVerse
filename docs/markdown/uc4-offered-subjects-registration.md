...
1. Το σύστημα εμφανίζει μήνυμα στον Υπέυθυνο Γραμματείας σχετικά με το ποιο από τα 2 θέλει να κρατήσει (Παλιά ή καινούρια επιλογή εξαμήνου).
2. Ο Υπεύθυνος Γραμματείας κάνει την επιλογή.
    * 2α. Ο Υπεύθυνος Γραμματείας επέλεξε την παλιά έκδοση.
...
![Διάγραμμα Δραστηριοτήτων 4](uml/requirements/UseCase4.jpg)

---
**Διάγραμμα Ακολουθίας**

![Διαγραμμα Ακολουθίας 4]()
