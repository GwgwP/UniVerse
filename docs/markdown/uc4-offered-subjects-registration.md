...
4. Το σύστημα κάνει τους απαραίτητους ελέγχους με αναζήτηση στο αν έχει ήδη γίνει δήλωση για το συγκεκριμένο έτος και εξάμηνο.
5. Το σύστημα αναζητά τα προσφερόμενα μαθήματα του προηγούμενου έτους στο ίδιο εξάμηνο.
6. Το σύστημα εμφανίζει μια λίστα με όλα τα καταχωρημένα μαθήματα και προεπιλεγμένα εκείνα από την περσινή δήλωση μαθημάτων.
7. Ο Υπεύθυνος Γραμματείας επιλέγει τα μαθήματα που θα προσφερθούν (προσθήκη νέων μαθημάτων ή αφαίρεση των προεπιλεγμένων από την περσινή δήλωση).
8. Ο Υπεύθυνος Γραμματείας υποβάλλει το αίτημα.
9. Το σύστημα κάνει τους απαραίτητους ελέγχους (αν υπάρχει μάθημα το οποίο είναι ήδη προσφερόμενο).
10. Το σύστημα καταχωρεί την δήλωση των προσφερόμενων μαθημάτων.
...
*9α. Το μάθημα είναι ήδη προσφερόμενο*
